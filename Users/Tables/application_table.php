...
<table id="applications" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            $applications = mysql_query("SELECT application_id, applicant_name, applicant_contact, application_status, application_title, applicant_email, job_vacancy, DATE_FORMAT(DATE(application_date), '%D %M %Y') AS app_date FROM applications ORDER BY application_id") or die(mysql_error());
            ...
            While($row = mysql_fetch_assoc($applications)){ ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../Admin/edit_application.php?edit_id=<?php echo $row['application_id']; ?>" alt="edit" class="btn btn-warning btn-sm"><i class="icon-edit-sign"></i></a>
