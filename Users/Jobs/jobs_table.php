<div class="block-content collapse in" xmlns="http://www.w3.org/1999/html">
    <div class="table-container">
        <table class="table table-striped">
            ...
            $job_posts = mysql_query("SELECT job_id, job_title, category, work_type, status, location, position, DATE_FORMAT(deadline, '%d %b %Y') AS deadline, DATE_FORMAT(DATE(created), '%d %b %Y') AS posted FROM jobs WHERE status = 'Approved' AND deadline >= CURDATE() ORDER BY created DESC") or die(mysql_error());
