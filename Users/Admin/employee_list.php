<div class="block-content collapse in">
    <table id="shortlisted" class="table table-striped" cellspacing="0" width="100%">
        ...
        $application = mysql_query("SELECT staff_id, CONCAT(first_name, ' ', middle_name, ' ', last_name)AS full_name, role, department, employement, status, created FROM staff WHERE role = 'Employee' OR role = 'HOD' OR role = 'H.R.' ORDER BY created DESC ") or die(mysql_error());
