                    ...
                    <div class="form-horizontal col-md-12">
                        <div class="tabbable">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#profile" data-toggle="tab"><i class="icon-question-sign"></i> Pending</a>
                                </li>
                                <li>
                                    <a href="#balance" data-toggle="tab"><i class="icon-ok-sign"></i> Approved</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="profile">
                                    <div class="table-container">
                                        <hr />
                                        <div class="table-container">
                                            <h4><i class=""></i> Pending</h4>
                                            <hr />
                                            <br>
                                            <?php include '../Tables/leave_requests.php'; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="balance">
                                    <div class="table-container">
                                        <hr />
                                        <div class="table-container">
                                            <h4><i class=""></i> Approved</h4>
                                            <hr />
                                            <br>
                                            <?php include '../Tables/approved_leave.php'; ?>
                                        </div>
                                    </div>
                                </div>
