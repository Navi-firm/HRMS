                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <?php include '../../processes/new_event.php'; ?>
                            <form id="add_job" class="form-horizontal" name="" action="" method="post">
                                <legend>Create New Event</legend>
                                <fieldset>
                                    <div class="form-group">
                                        <label for="job_vacancy" class="col-md-3"> Event Name </label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="job_name" value="" name="e_name" placeholder="">
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->

                                    <div class="form-group">
                                        <label for="job_vacancy" class="col-md-3"> Event Date : </label>
                                        <div class="col-md-4">
                                            <input id="datepicker" class="form-control" value="" name="start_date" placeholder="01/12/2016"/>
                                        </div> <!-- /controls -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="datepicker1" class="form-control" value="" name="end_date" placeholder="01/12/2016"/>
                                        </div> <!-- /controls -->

                                    </div>

                                    <div class="form-group">
                                        <label for="job_vacancy" class="col-md-3"> Venue </label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="job_name" value="" name="venue" placeholder="">
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->

                                    <div class="form-group">
                                        <label for="job_vacancy" class="col-md-3"> Description </label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <div class=" col-md-12">
                                            <button type="submit" name="create_task" onclick="javascript:send_post()" class="btn btn-primary"><i class="icon-plus"></i> Save </button>
                                        </div>
                                    </div> <!-- /form-actions -->
                                </fieldset>
                            </form>
