                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-xs-4 text-center">
                                <div class="panel panel-info">
                                    <div class="panel-body">
                                        <h3><?php echo task_inprogress(); ?></h3>
                                    </div>
                                    <div class="panel-heading">
                                        <p>Pending</p>
                                    </div>
                    ...
                    <div class="form-horizontal col-md-12">
                        <div class="tabbable">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#profile" data-toggle="tab"><i class="icon-tasks"></i> All Tasks</a>
                                </li>
                                <li>
                                    <a href="#balance" data-toggle="tab"><i class="icon-plus-sign"></i> New Task</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="profile">
                                    <div class="table-container">
                                        <hr />
                                        <div class="table-container">
                                            <h5><i class="icon-tasks"></i> All Tasks</h5>
                                            <hr />
                                            <br>
                                            <?php include '../Tables/tasks_table.php'; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="balance">
                                    <form id="add_job" class="form-horizontal col-md-12" name="" action="" method="post">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <div class=" col-md-12">
                                                    <button type="submit" name="create_task" onclick="javascript:send_post()" class="btn btn-primary"><i class="icon-plus"></i> Create </button>
                                                </div>
                                            </div> <!-- /form-actions -->
                                        </fieldset>
                                    </form>
