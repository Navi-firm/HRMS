            ...
            <div class="col-md-8">
                ...
                <div class="widget stacked ">
                    ...
                    <div class="widget-header">
                        <i class="icon-user"></i>
                        <h3> <strong></strong>Add New Employee</h3>
                    </div> <!-- /widget-header -->
                            ...
                            <div class="tab-content">
                                <?php
                                    $add_employee = "BEGIN;
                                                     ...
                                                     INSERT INTO users () VALUES (LAST_INSERT_ID(),);
                                                     COMMIT;";
                                ?>
                                <div class="tab-pane active" id="profile">
                                    ...
                                    <hr>
                                    <br />
                                    <form id="add_employee" class="form-horizontal col-md-8" method="post" action="">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <p class="help-block">First name and Last name make username eg. John.Doe </p>
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->

                                            <script type="text/javascript">
                                                function randomnumber(){
                                                    var generator = Math.random()*6;
                                            ...
                                            <div class="form-group">
                                                <label for="firstname" class="col-md-4">Staff Number </label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="number" name="staff_number" value="" placeholder="Staff Number">
                                                    <a class="btn btn-default" id="random">New Staff Number</a>
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="lastname" name="last_name" value="" placeholder="Firstname">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="id" name="id_number"  value="" name="id_number">
                                                </div> <!-- /controls -->
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4" for="gender">Status : </label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4" for="user_role">User Role </label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-offset-4 col-md-8">
                                                    <button type="submit" class="btn btn-success" id="add_employee"><i class="icon-plus-sign-alt"></i> Add Employee</button>
