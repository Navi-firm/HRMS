<div class="block-content collapse in">
    <table id="interview" class="table table-striped" cellspacing="0" width="100%">
        ...
        $application = mysql_query("SELECT application_id, application_title, applicant_name, department, DATE_FORMAT(DATE(application_date), '%D %M %Y') AS app_date, applicant_contact, applicant_email, application_status, resume, cover_letter FROM applications WHERE application_status = '50 -50' OR application_status = 'Pending Review' OR application_status = 'Reject' ORDER BY application_date DESC ") or die(mysql_error());
