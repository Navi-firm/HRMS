            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h5><strong><i class="icon-briefcase"></i> Job Postings</strong></h5>
                    </div>
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="col-xs-4 text-center">
                                <div class="panel panel-info">
                                    <div class="panel-body">
                                        <h3><?php echo pending_job(); ?></h3>
                                    </div>
                                    <div class="panel-heading">
                                        <p>Panding Approval</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 form-horizontal">
                            <br>
                            <a href="new_job.php" class="btn btn-primary pull-right"><i class="icon-plus"></i> New Vacancy</a>
                            <br>
                        </div>
                        <hr />
                    </div>
                    <div class="col-md-12 form-horizontal">
                        <div class="tabbable">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#profile" data-toggle="tab"><i class="icon-tasks"></i> New Jobs </a>
                                </li>
                                <li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="profile">
                                    <div class="table-container">
                                        <hr />
                                        <div class="table-container">
                                            <h5><i class="icon-tasks"></i> Job Posting</h5>
                                            <hr />
                                ...
                                <div class="tab-pane" id="balance">
                                    <div class="table-container">
                                        <hr />
                                        <div class="table-container">
                                            <h5><i class="icon-tasks"></i> Pending Approval</h5>
                                            <hr />
