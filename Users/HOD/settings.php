                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-md-4">
                                                <div class="user-info-left">
                                                    ...
                                                    <h3><?php echo $user['fullname']; ?> <i class="fa fa-circle green-font online-icon"></i><sup class="sr-only">online</sup></h3>
                                                </div>
                                            </div>
                                                ...
                                                <div class="user-info-right">
                                                    <div class="basic-info">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="number" class="form-control" id="username" value="<?php echo $user['passport']; ?>" name="passport" placeholder="ID/ Passport">
                                                            </div> <!-- /controls -->
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" id="username" value="<?php echo $user['dob']; ?>" name="birth_date" placeholder="DOB eg. 03/12/2015">
                                                            </div> <!-- /controls -->
                                                        </div> <!-- /control-group -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <p class="help-block"><?php echo $user['joined']; ?></p>
                                                            </div> <!-- /controls -->
                                                        </div> <!-- /control-group -->
                                                        ...
                                                        <div class="contact_info">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="number" class="form-control" id="username" value="<?php echo $user['phone']; ?>" maxlength="13" min="10" name="phone" placeholder="Phone eg. +254 700 124568">
                                                                </div> <!-- /controls -->
                                                            </div> <!-- /control-group -->
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="text" class="form-control" id="username" value="<?php echo $user['address']; ?>" name="address" placeholder="227 - 01000 Nairobi, Kenya">
                                                                </div> <!-- /controls -->
                                                            </div> <!-- /control-group -->
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="text" class="form-control" id="username" value="<?php echo $user['linkedin']; ?>" name="linkedin" placeholder="your linked in URL">
                                                                </div> <!-- /controls -->
                                                            </div> <!-- /control-group -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                <textarea name="about" class="form-control" rows="6" placeholder="Describe yourself" maxlength="400"><?php echo $user['about']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <hr />
                                                        <div class="form-group">
