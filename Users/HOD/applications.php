<?php include '../includes/hod_header.php'; ?>
    ...
    <div class="main">
        <div class="container">
            ...
            <?php
            $applicant = mysql_query("SELECT staff_id, CONCAT(first_name,' ', middle_name, ' ', last_name) AS fullname, phone, postal_code, about, CONCAT(county, ', ', country) AS location, gender, email, postal_code, department, address, DATE_FORMAT(created, '%d %M %Y') AS joined, pro_pic FROM staff WHERE staff_id =". $user_data['user_id']);
                    ...
                    <div class="widget stacked">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="col-md-12">
                                ...
                                $my_employees = mysql_query("SELECT COUNT(application_id) AS my_jobs FROM applications WHERE department = '$author'");
                                ...
                                <?php
                                $author =  $user['department'];
                                $my_employees = mysql_query("SELECT COUNT(application_id) AS my_jobs FROM applications WHERE department = '$author' AND application_status = 'Reject'");
                                ...
                                <?php
                                $author =  $user['department'];
                                $my_employees = mysql_query("SELECT COUNT(application_id) AS my_jobs FROM applications WHERE department = '$author' AND application_status = 'Pending Review'");
                            ...
                            <div class="form-horizontal col-md-12">
                                ...
                                <hr />
                                <br>
                                <?php include 'application_table.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
