                ...
                <div class="col-md-9">
                    <div class="widget stacked">
                        ...
                        <div class="widget-content">
                            ...
                            <?php include '../../processes/new_department.php'; ?>
                                ...
                                <form id="add_job" class="form-horizontal col-md-12" name="" action="" method="post">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" id="job_name" value="" name="d_name" placeholder="eg. Finance">
                                            </div> <!-- /controls -->
                                        </div> <!-- /control-group -->

                                        <div class="form-group">
                                            <label for="job_vacancy" class="col-md-12"> Department Category </label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="job_name" value="" name="d_category" placeholder="eg. Accounting">
                                            </div> <!-- /controls -->
                                        </div> <!-- /control-group -->

                                        <div class="form-group">
                                            <label class="col-md-12" for="lastname"> About Department </label>
                                            <div class="col-md-9">
                                                <textarea class="form-control" name="d_description" id="reason" rows="15" cols="80" placeholder="Give description"></textarea>
                                            </div> <!-- /controls -->
                                        </div> <!-- /control-group -->

                                        <div class="form-group">
                                            <label class="col-md-12" for="budget"> Location </label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="job_name" value="" name="d_location" placeholder="eg. CBD Nairobi, Kenya">
                                                </div> <!-- /controls -->
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-12" for="budget"> Head of Department </label>
                                            <div class="col-md-6">
                                                <select class="form-control" id="budget" name="hod">
                                                    <option value="" selected="selected">Choose Department Head</option>
                                                    <?php
                                                        //Load names from staff
                                                        $hod = mysql_query("SELECT CONCAT(first_name, ' ', middle_name, ' ', last_name) AS fullname, staff_id, role, department FROM staff WHERE role = 'Employee' ORDER BY fullname ASC") or die(mysql_error());
                                                            While($row = mysql_fetch_assoc($hod)){
                                                                echo "<option value='".$row['fullname']."'>".$row['fullname']."(". $row['role'] .") ". $row['department'] ."</option>";
                                                                }
                                                                ?>
                                                </select>
                                            </div> <!-- /controls -->
