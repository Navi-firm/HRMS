            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="widget stacked">
                        ...
                        {
                            $sql_query="DELETE FROM department WHERE department_id = ".$_GET['delete_id'];
                        ...
                        <div class="widget-content">
                            ...
                            <a href="new_department.php" alt="edit" class="btn btn-primary btn-sm pull-right"><i class="icon-plus-sign-alt"></i> New Department </a>
                            <br>
                            <hr />
                            <?php include 'departments_table.php'; ?>
                        </div>
                    </div>
                </div>
            </div>
